                ...
                .newRule()
                    ...
                    .when()
                        .challenge()
                            ...
                            .bindFromField("$counter", "counterName")
                            .bindFromField("$target", "target")
                            .bindFromField("$vp", "virtualPrice")
                    ...
                    .name("real_rule")
                        .when()
                            .challenge("$challenge")
                                ...
                                .bindFromField("$bonusScore", "bonusScore")
                                .bindFromField("$bonusPointType", "bonusPointType")
                                .isCompleted(false)
                            .end()
                            .reward("$reward").end()
